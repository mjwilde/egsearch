...
def test_combos(D):
	...
	for combo in combos_to_test:
		...
		slices =  [islice(groups, (i * total / number_of_slices)    ,     ((i * total / number_of_slices) + total / number_of_slices))  for i in range(number_of_slices)]
...
def joinslices():
	...
	output = []
	for file_number in range(number_of_slices):
