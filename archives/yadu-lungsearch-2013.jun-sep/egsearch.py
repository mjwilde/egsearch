...
def readfile(name_of_file):
	...
	name_of_file = "/home/slv/egsearch/full.csv"
...
number_of_slices = 10
#results_filename = '/home/slv/egsearch'+'/'+'williamson_genes_normalized_all.csv' # FIXME: ship via swift
#results_filename = '/home/slv/egsearch'+'/'+'short2.csv' # FIXME: ship via swift
results_filename = 'full.csv' # FIXME: ship via swift
